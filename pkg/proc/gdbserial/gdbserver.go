...
import (
	...
	"github.com/backman-git/delve/pkg/proc/internal/ebpf"
	"github.com/backman-git/delve/pkg/proc/linutil"
	"github.com/backman-git/delve/pkg/proc/macutil"
)
...
func (p *gdbProcess) Connect(conn net.Conn, path, cmdline string, pid int, debugInfoDirs []string, stopReason proc.StopReason) (*proc.TargetGroup, error) {
	...
	if p.conn.isDebugserver {
		...
		// zeroed out (https://github.com/backman-git/delve/pull/2498).
