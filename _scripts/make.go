...
const DelveMainPackagePath = "github.com/backman-git/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/backman-git/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/backman-git/delve/pkg/proc", "github.com/backman-git/delve/service/test", "github.com/backman-git/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/backman-git/delve/service/test"}
